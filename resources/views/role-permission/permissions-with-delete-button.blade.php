         ...
         <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    {{ Form::open(['route' => 'save-role-permissions','method' => 'post']) }}
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @foreach ($roles as $role)
                                        ...
                                        <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" data-modal-form="form"  data--href="{{ route('role.edit', ['role' => $role->id]) }}" data-app-title="Edit Role" data-placement="top" title="Edit Role" href="#">
                                        ...
                                        <a class="btn btn-sm btn-icon text-danger"  data-bs-toggle="tooltip" data-modal-form="form"  data--href="{{ route('role.confirmdelete', ['role' => $role->id]) }}" data-app-title="Delete Role" data-placement="top" title="Delete User" href="#">
                                            <span class="btn-inner">
